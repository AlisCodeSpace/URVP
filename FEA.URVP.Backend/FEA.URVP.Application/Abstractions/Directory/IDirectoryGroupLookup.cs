...
/// (Students-STD / ALLACADstaff-STF, including nested groups) to resolve Student vs Faculty.
/// </summary>
public interface IDirectoryGroupLookup
{
    /// <summary>
    /// Resolves Student or Faculty from AD group membership, including nested groups.
    /// Searches user objects in order: <c>sAMAccountName</c>, <c>userPrincipalName</c>, then <c>mail</c>.
