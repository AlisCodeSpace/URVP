...
{
    public class RejectFieldCommandHandler : BaseCommandHandler<RejectFieldCommand, bool>
    {
        private readonly IResearchFieldRepository _repository;
        private readonly IEventBus _eventBus;
        public RejectFieldCommandHandler(
            ILogger<RejectFieldCommandHandler> logger,
        ...
        protected override async Task<bool> HandleInternal(RejectFieldCommand request, CancellationToken cancellationToken)
        {
            // Get the field to reject (validation already handled by base class)
            ...
            field.Status = ApprovalStatus.Rejected;
            ...
            await _eventBus.PublishAsync(new ResearchFieldRejectedEvent(
                field.Id,
                request.RejectedBy,
